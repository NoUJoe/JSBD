...
//#############################################################################
{
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "halfCeil", maximumFractionDigits: 3}).toString ()).toEqual ("-69.696");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "halfCeil", maximumFractionDigits: 2}).toString ()).toEqual ("-69.69");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "halfCeil", maximumFractionDigits: 1}).toString ()).toEqual ("-69.6");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "halfCeil", maximumFractionDigits: 0}).toString ()).toEqual ("-69");
    ...
    //Increment 2
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "halfCeil", roundingIncrement: 2}).toString ()).toEqual ("-69.6968");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "halfCeil", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-69.6968");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.699"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.698");
    expect (JSBD.round (JSBD.BigD ("-69.697"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.694");
    expect (JSBD.round (JSBD.BigD ("-69.693"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.692");
    expect (JSBD.round (JSBD.BigD ("-69.691"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.69");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.67"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.66");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.64");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.9"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.8");
    expect (JSBD.round (JSBD.BigD ("-69.7"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.6"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.4");
    expect (JSBD.round (JSBD.BigD ("-69.4"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.4");
    expect (JSBD.round (JSBD.BigD ("-69.3"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.2");
    expect (JSBD.round (JSBD.BigD ("-69.1"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69");
    ...
    expect (JSBD.round (JSBD.BigD ("-69"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-68"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-67"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-66");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-64");
    expect (JSBD.round (JSBD.BigD ("-63"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-62");
    expect (JSBD.round (JSBD.BigD ("-61"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-60");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6925"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.69");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.625"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.6");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.25"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69");
    ...
    expect (JSBD.round (JSBD.BigD ("-62.5000"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-60");
    ...
    expect (JSBD.round (JSBD.BigD ("-67.5000"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "halfCeil", roundingIncrement: 10}).toString ()).toEqual ("-69.696");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "halfCeil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.696");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6950"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.69");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6500"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.6");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.5000"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-69");
    ...
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "halfCeil", maximumFractionDigits: 3}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.0055"), {roundingMode: "halfCeil", maximumFractionDigits: 3}).toString ()).toEqual ("-0.005");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.095"), {roundingMode: "halfCeil", maximumFractionDigits: 2}).toString ()).toEqual ("-0.09");
    expect (JSBD.round (JSBD.BigD ("-0.0949"), {roundingMode: "halfCeil", maximumFractionDigits: 2}).toString ()).toEqual ("-0.09");

    expect (JSBD.round (JSBD.BigD ("-0.65"), {roundingMode: "halfCeil", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.55"), {roundingMode: "halfCeil", maximumFractionDigits: 1}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.64"), {roundingMode: "halfCeil", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");

    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "halfCeil", maximumFractionDigits: 0}).toString ()).toEqual ("0");
    ...
    //Zeros - Increment 2
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "halfCeil", roundingIncrement: 2}).toString ()).toEqual ("-0.0068");
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "halfCeil", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-0.0068");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.009"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.008");
    expect (JSBD.round (JSBD.BigD ("-0.007"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.005"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.004");
    expect (JSBD.round (JSBD.BigD ("-0.003"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.002");
    expect (JSBD.round (JSBD.BigD ("-0.001"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.07"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.06");
    expect (JSBD.round (JSBD.BigD ("-0.06"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.06");
    expect (JSBD.round (JSBD.BigD ("-0.05"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.04");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.9"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.8");
    expect (JSBD.round (JSBD.BigD ("-0.7"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.6"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.4"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.3"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.2");
    expect (JSBD.round (JSBD.BigD ("-0.1"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("0");

    expect (JSBD.round (JSBD.BigD ("-8.6969"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-9"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-8"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-7"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-6");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-4");
    expect (JSBD.round (JSBD.BigD ("-3"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-2");
    expect (JSBD.round (JSBD.BigD ("-1"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0025"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0024"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0075"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.075"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.025"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.75"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.25"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-2.5000"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-2.4999"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-7.5000"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    ...
    expect (JSBD.round (JSBD.BigD ("-2.5"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "halfCeil", roundingIncrement: 10}).toString ()).toEqual ("-0.006");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "halfCeil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.006");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0050"), {roundingMode: "halfCeil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0500"), {roundingMode: "halfCeil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.5000"), {roundingMode: "halfCeil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("0");
...
//#############################################################################
{
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "halfFloor", maximumFractionDigits: 3}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6955"), {roundingMode: "halfFloor", maximumFractionDigits: 3}).toString ()).toEqual ("-69.696");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "halfFloor", maximumFractionDigits: 2}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.685"), {roundingMode: "halfFloor", maximumFractionDigits: 2}).toString ()).toEqual ("-69.69");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "halfFloor", maximumFractionDigits: 1}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.55"), {roundingMode: "halfFloor", maximumFractionDigits: 1}).toString ()).toEqual ("-69.6");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "halfFloor", maximumFractionDigits: 0}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-68.5"), {roundingMode: "halfFloor", maximumFractionDigits: 0}).toString ()).toEqual ("-69");
    ...
    //Increment 2
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "halfFloor", roundingIncrement: 2}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "halfFloor", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-69.697");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.699"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.697"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.698");
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.693"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.694");
    expect (JSBD.round (JSBD.BigD ("-69.691"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.692");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.67"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.68");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.66");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.9"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.7"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.8");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.3"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.4");
    expect (JSBD.round (JSBD.BigD ("-69.1"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.2");
    ...
    expect (JSBD.round (JSBD.BigD ("-69"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-68"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-67"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-66");
    expect (JSBD.round (JSBD.BigD ("-63"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-64");
    expect (JSBD.round (JSBD.BigD ("-61"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-62");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6925"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6975"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.675"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.625"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.65");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.75"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-70");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.25"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    ...
    expect (JSBD.round (JSBD.BigD ("-62.5000"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    ...
    expect (JSBD.round (JSBD.BigD ("-67.5000"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    ...
    expect (JSBD.round (JSBD.BigD ("-62.5"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "halfFloor", roundingIncrement: 10}).toString ()).toEqual ("-69.697");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "halfFloor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.697");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6950"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6500"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.5000"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-70");
    ...
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-70");
    ...
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "halfFloor", maximumFractionDigits: 3}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0055"), {roundingMode: "halfFloor", maximumFractionDigits: 3}).toString ()).toEqual ("-0.006");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.095"), {roundingMode: "halfFloor", maximumFractionDigits: 2}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.0949"), {roundingMode: "halfFloor", maximumFractionDigits: 2}).toString ()).toEqual ("-0.09");

    expect (JSBD.round (JSBD.BigD ("-0.65"), {roundingMode: "halfFloor", maximumFractionDigits: 1}).toString ()).toEqual ("-0.7");
    expect (JSBD.round (JSBD.BigD ("-0.55"), {roundingMode: "halfFloor", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.64"), {roundingMode: "halfFloor", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");

    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "halfFloor", maximumFractionDigits: 0}).toString ()).toEqual ("-1");
    ...
    //Zeros - Increment 2
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "halfFloor", roundingIncrement: 2}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "halfFloor", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-0.007");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.009"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.007"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.008");
    expect (JSBD.round (JSBD.BigD ("-0.005"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.003"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.004");
    expect (JSBD.round (JSBD.BigD ("-0.001"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.002");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.07"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.08");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.05"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.06");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.9"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.7"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.8");
    expect (JSBD.round (JSBD.BigD ("-0.6"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.4"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.3"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.1"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.2");

    expect (JSBD.round (JSBD.BigD ("-8.6969"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-9"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-8"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-7"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-6");
    expect (JSBD.round (JSBD.BigD ("-3"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-4");
    expect (JSBD.round (JSBD.BigD ("-1"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-2");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0025"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.0024"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0075"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.01");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.075"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.1");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.025"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.75"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-1");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.25"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    ...
    expect (JSBD.round (JSBD.BigD ("-2.5000"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-2.4999"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-7.5000"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    ...
    expect (JSBD.round (JSBD.BigD ("-2.5"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "halfFloor", roundingIncrement: 10}).toString ()).toEqual ("-0.007");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "halfFloor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.007");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0050"), {roundingMode: "halfFloor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-0.01");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0500"), {roundingMode: "halfFloor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-0.1");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.5000"), {roundingMode: "halfFloor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-1");
...
//#############################################################################
{
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 3}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "floor", maximumFractionDigits: 3}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6955"), {roundingMode: "floor", maximumFractionDigits: 3}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "floor", maximumFractionDigits: 3}).toString ()).toEqual ("-69.697");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.685"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6949"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-69.7");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.55"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.64"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-69.7");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 0}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "floor", maximumFractionDigits: 0}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-68.5"), {roundingMode: "floor", maximumFractionDigits: 0}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.4"), {roundingMode: "floor", maximumFractionDigits: 0}).toString ()).toEqual ("-70");
    ...
    //Increment 2
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", roundingIncrement: 2}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-69.697");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.698");
    expect (JSBD.round (JSBD.BigD ("-69.699"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.697"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.698");
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.693"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.694");
    expect (JSBD.round (JSBD.BigD ("-69.691"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.692");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.68"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.68");
    expect (JSBD.round (JSBD.BigD ("-69.67"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.68");
    expect (JSBD.round (JSBD.BigD ("-69.66"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.66");
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.66");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.8");
    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.8");
    expect (JSBD.round (JSBD.BigD ("-69.9"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.7"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.8");
    expect (JSBD.round (JSBD.BigD ("-69.6"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.4"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.4");
    expect (JSBD.round (JSBD.BigD ("-69.3"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.4");
    expect (JSBD.round (JSBD.BigD ("-69.1"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.2");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-68.6969"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-68"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-67"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-66");
    expect (JSBD.round (JSBD.BigD ("-63"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-64");
    expect (JSBD.round (JSBD.BigD ("-61"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-62");
    ...
    //Increment 5
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", roundingIncrement: 5}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 5}).toString ()).toEqual ("-69.697");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    ...
    expect (JSBD.round (JSBD.BigD ("-69.693"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.6925"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.6924"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.6975"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6974"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6976"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.7");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.675"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6749"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.625"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.65");
    expect (JSBD.round (JSBD.BigD ("-69.62501"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.65");
    expect (JSBD.round (JSBD.BigD ("-69.62499"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.65");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.75"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.7501"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.7499"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.25001"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.25"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.2499"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.4999"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.5001"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-70");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-65.6969"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-62.5000"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-62.4999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-67.5000"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-67.4999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-68"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-67"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-66"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-64"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-63"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-62"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    ...
    //Increment 10
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", roundingIncrement: 10}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "floor", roundingIncrement: 10}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "floor", roundingIncrement: 10}).toString ()).toEqual ("-69.697");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.69651"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.697");
    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.697");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6950"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6951"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6949"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.7");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6500"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6501"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.7");
    expect (JSBD.round (JSBD.BigD ("-69.6499"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.7");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.5000"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.5001"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-69.4999"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-70");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-65.5000"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-65.4999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-64.9999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-70");
    expect (JSBD.round (JSBD.BigD ("-6.9696"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5.9696"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-4.9999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "floor", maximumFractionDigits: 3}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0055"), {roundingMode: "floor", maximumFractionDigits: 3}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "floor", maximumFractionDigits: 3}).toString ()).toEqual ("-0.007");

    expect (JSBD.round (JSBD.BigD ("-0.0951"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.095"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.0949"), {roundingMode: "floor", maximumFractionDigits: 2}).toString ()).toEqual ("-0.1");

    expect (JSBD.round (JSBD.BigD ("-0.65"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-0.7");
    expect (JSBD.round (JSBD.BigD ("-0.55"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.64"), {roundingMode: "floor", maximumFractionDigits: 1}).toString ()).toEqual ("-0.7");

    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "floor", maximumFractionDigits: 0}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.6"), {roundingMode: "floor", maximumFractionDigits: 0}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.4"), {roundingMode: "floor", maximumFractionDigits: 0}).toString ()).toEqual ("-1");
    ...
    //Zeros - Increment 2
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", roundingIncrement: 2}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-0.007");

    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.008");
    expect (JSBD.round (JSBD.BigD ("-0.009"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.007"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.008");
    expect (JSBD.round (JSBD.BigD ("-0.005"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.003"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.004");
    expect (JSBD.round (JSBD.BigD ("-0.001"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.002");

    expect (JSBD.round (JSBD.BigD ("-0.0969"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.08"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.08");
    expect (JSBD.round (JSBD.BigD ("-0.07"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.08");
    expect (JSBD.round (JSBD.BigD ("-0.06"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.06");
    expect (JSBD.round (JSBD.BigD ("-0.05"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.06");

    expect (JSBD.round (JSBD.BigD ("-0.6969"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.8");
    expect (JSBD.round (JSBD.BigD ("-0.9"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.7"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.8");
    expect (JSBD.round (JSBD.BigD ("-0.6"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.4"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.3"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.1"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.2");

    expect (JSBD.round (JSBD.BigD ("-8.6969"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-9"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-8"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-7"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-6");
    expect (JSBD.round (JSBD.BigD ("-3"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-4");
    expect (JSBD.round (JSBD.BigD ("-1"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-2");
    ...
    //Zeros - Increment 5
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", roundingIncrement: 5}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 5}).toString ()).toEqual ("-0.007");

    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.005"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.003"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.0025"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.0024"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.0075"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.0074"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.0076"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.01");

    expect (JSBD.round (JSBD.BigD ("-0.0869"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.075"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.0749"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.025"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");
    expect (JSBD.round (JSBD.BigD ("-0.02501"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");
    expect (JSBD.round (JSBD.BigD ("-0.02499"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");

    expect (JSBD.round (JSBD.BigD ("-0.6969"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.75"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.7501"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.7499"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.25001"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.25"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.2499"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.4999"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.5001"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-1");

    expect (JSBD.round (JSBD.BigD ("-9.6869"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5.6969"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-2.5000"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-2.4999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-7.5000"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-7.4999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-9"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-8"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-7"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-6"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-4"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-3"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-2"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    ...
    //Zeros - Increment 10
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", roundingIncrement: 10}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "floor", roundingIncrement: 10}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "floor", roundingIncrement: 10}).toString ()).toEqual ("-0.007");

    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.00651"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.007");
    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.007");

    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.0050"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.0051"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-0.01");
    expect (JSBD.round (JSBD.BigD ("-0.0049"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-0.01");

    expect (JSBD.round (JSBD.BigD ("-0.0964"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.0500"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.0501"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-0.1");
    expect (JSBD.round (JSBD.BigD ("-0.0499"), {roundingMode: "floor", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-0.1");

    expect (JSBD.round (JSBD.BigD ("-0.6964"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.5000"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.5001"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-1");
    expect (JSBD.round (JSBD.BigD ("-0.4999"), {roundingMode: "floor", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-1");

    expect (JSBD.round (JSBD.BigD ("-9.6964"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5.5000"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5.4999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-4.9999"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-6.9696"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
    expect (JSBD.round (JSBD.BigD ("-5.9696"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-10");
...
//#############################################################################
{
    ...
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.6955"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-69.696");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-69.68");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.685"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-69.68");
    expect (JSBD.round (JSBD.BigD ("-69.6949"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-69.69");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.55"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.64"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-69.6");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 0}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "ceil", maximumFractionDigits: 0}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-68.5"), {roundingMode: "ceil", maximumFractionDigits: 0}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-69.4"), {roundingMode: "ceil", maximumFractionDigits: 0}).toString ()).toEqual ("-69");
    ...
    //Increment 2
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", roundingIncrement: 2}).toString ()).toEqual ("-69.6968");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-69.6968");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.699"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.698");
    expect (JSBD.round (JSBD.BigD ("-69.697"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.694");
    expect (JSBD.round (JSBD.BigD ("-69.693"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.692");
    expect (JSBD.round (JSBD.BigD ("-69.691"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-69.69");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.68");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.68");
    expect (JSBD.round (JSBD.BigD ("-69.68"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.68");
    expect (JSBD.round (JSBD.BigD ("-69.67"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.66");
    expect (JSBD.round (JSBD.BigD ("-69.66"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.66");
    expect (JSBD.round (JSBD.BigD ("-69.65"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-69.64");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.9"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.8");
    expect (JSBD.round (JSBD.BigD ("-69.7"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.6"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.4");
    expect (JSBD.round (JSBD.BigD ("-69.4"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.4");
    expect (JSBD.round (JSBD.BigD ("-69.3"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69.2");
    expect (JSBD.round (JSBD.BigD ("-69.1"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-69");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-68.6969"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-69"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-68"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-68");
    expect (JSBD.round (JSBD.BigD ("-67"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-66");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-64");
    expect (JSBD.round (JSBD.BigD ("-63"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-62");
    expect (JSBD.round (JSBD.BigD ("-61"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-60");
    ...
    //Increment 5
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", roundingIncrement: 5}).toString ()).toEqual ("-69.6965");
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 5}).toString ()).toEqual ("-69.6965");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.695"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.693"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6925"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6924"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6975"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.6974"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");
    expect (JSBD.round (JSBD.BigD ("-69.6976"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-69.695");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.65");
    expect (JSBD.round (JSBD.BigD ("-69.675"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.65");
    expect (JSBD.round (JSBD.BigD ("-69.6749"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.65");
    expect (JSBD.round (JSBD.BigD ("-69.625"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.62501"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.62499"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-69.6");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.75"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.7501"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.7499"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.25001"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.25"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.2499"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.5"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");
    expect (JSBD.round (JSBD.BigD ("-69.4999"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.5001"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-69.5");

    expect (JSBD.round (JSBD.BigD ("-69.6869"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-65.6969"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-62.5000"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-62.4999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-67.5000"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-67.4999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-69"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-68"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-67"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-66"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-65");
    expect (JSBD.round (JSBD.BigD ("-64"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-63"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-62"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-60");
    ...
    //Increment 10
    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", roundingIncrement: 10}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "ceil", roundingIncrement: 10}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "ceil", roundingIncrement: 10}).toString ()).toEqual ("-69.696");

    expect (JSBD.round (JSBD.BigD ("-69.6969"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.6965"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.69651"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.696");
    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-69.696");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6950"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6951"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.69");
    expect (JSBD.round (JSBD.BigD ("-69.6949"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("-69.69");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.6500"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.6501"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.6");
    expect (JSBD.round (JSBD.BigD ("-69.6499"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("-69.6");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.5000"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.5001"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-69");
    expect (JSBD.round (JSBD.BigD ("-69.4999"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("-69");

    expect (JSBD.round (JSBD.BigD ("-69.6964"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-65.5000"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-65.4999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-65"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-64.9999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("-60");
    expect (JSBD.round (JSBD.BigD ("-6.9696"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-5.9696"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-4.9999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    ...
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.006"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.0055"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "ceil", maximumFractionDigits: 3}).toString ()).toEqual ("-0.006");

    expect (JSBD.round (JSBD.BigD ("-0.0951"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-0.09");
    expect (JSBD.round (JSBD.BigD ("-0.095"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-0.09");
    expect (JSBD.round (JSBD.BigD ("-0.0949"), {roundingMode: "ceil", maximumFractionDigits: 2}).toString ()).toEqual ("-0.09");

    expect (JSBD.round (JSBD.BigD ("-0.65"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.55"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.64"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.6"), {roundingMode: "ceil", maximumFractionDigits: 1}).toString ()).toEqual ("-0.6");

    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "ceil", maximumFractionDigits: 0}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.6"), {roundingMode: "ceil", maximumFractionDigits: 0}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.4"), {roundingMode: "ceil", maximumFractionDigits: 0}).toString ()).toEqual ("0");
    ...
    //Zeros - Increment 2
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", roundingIncrement: 2}).toString ()).toEqual ("-0.0068");
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 2}).toString ()).toEqual ("-0.0068");

    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.009"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.008");
    expect (JSBD.round (JSBD.BigD ("-0.007"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.005"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.004");
    expect (JSBD.round (JSBD.BigD ("-0.003"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("-0.002");
    expect (JSBD.round (JSBD.BigD ("-0.001"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 2}).toString ()).toEqual ("0");

    expect (JSBD.round (JSBD.BigD ("-0.0969"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.08");
    expect (JSBD.round (JSBD.BigD ("-0.08"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.08");
    expect (JSBD.round (JSBD.BigD ("-0.07"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.06");
    expect (JSBD.round (JSBD.BigD ("-0.06"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.06");
    expect (JSBD.round (JSBD.BigD ("-0.05"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 2}).toString ()).toEqual ("-0.04");

    expect (JSBD.round (JSBD.BigD ("-0.6969"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.9"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.8");
    expect (JSBD.round (JSBD.BigD ("-0.7"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.6"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.6");
    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.4"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.4");
    expect (JSBD.round (JSBD.BigD ("-0.3"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("-0.2");
    expect (JSBD.round (JSBD.BigD ("-0.1"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 2}).toString ()).toEqual ("0");

    expect (JSBD.round (JSBD.BigD ("-8.6969"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-9"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-8"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-8");
    expect (JSBD.round (JSBD.BigD ("-7"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-6");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-4");
    expect (JSBD.round (JSBD.BigD ("-3"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("-2");
    expect (JSBD.round (JSBD.BigD ("-1"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 2}).toString ()).toEqual ("0");
    ...
    //Zeros - Increment 5
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", roundingIncrement: 5}).toString ()).toEqual ("-0.0065");
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 5}).toString ()).toEqual ("-0.0065");

    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.005"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.003"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0025"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0024"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0075"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.0074"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");
    expect (JSBD.round (JSBD.BigD ("-0.0076"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 5}).toString ()).toEqual ("-0.005");

    expect (JSBD.round (JSBD.BigD ("-0.0869"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");
    expect (JSBD.round (JSBD.BigD ("-0.075"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");
    expect (JSBD.round (JSBD.BigD ("-0.0749"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("-0.05");
    expect (JSBD.round (JSBD.BigD ("-0.025"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.02501"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.02499"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 5}).toString ()).toEqual ("0");

    expect (JSBD.round (JSBD.BigD ("-0.6969"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.75"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.7501"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.7499"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.25001"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.25"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.2499"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.5"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");
    expect (JSBD.round (JSBD.BigD ("-0.4999"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.5001"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 5}).toString ()).toEqual ("-0.5");

    expect (JSBD.round (JSBD.BigD ("-9.6869"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-5.6969"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-2.5000"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-2.4999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-7.5000"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-7.4999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-9"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-8"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-7"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-6"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("-5");
    expect (JSBD.round (JSBD.BigD ("-4"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-3"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-2"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 5}).toString ()).toEqual ("0");
    ...
    //Zeros - Increment 10
    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", roundingIncrement: 10}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "ceil", roundingIncrement: 10}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "ceil", roundingIncrement: 10}).toString ()).toEqual ("-0.006");

    expect (JSBD.round (JSBD.BigD ("-0.0069"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.0065"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.00651"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.006");
    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 10}).toString ()).toEqual ("-0.006");

    expect (JSBD.round (JSBD.BigD ("-0.0064"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0050"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0051"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0049"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 10}).toString ()).toEqual ("0");

    expect (JSBD.round (JSBD.BigD ("-0.0964"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0500"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0501"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.0499"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 10}).toString ()).toEqual ("0");

    expect (JSBD.round (JSBD.BigD ("-0.6964"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.5000"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.5001"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-0.4999"), {roundingMode: "ceil", maximumFractionDigits: 1, roundingIncrement: 10}).toString ()).toEqual ("0");

    expect (JSBD.round (JSBD.BigD ("-0.6969"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-9.6964"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-5.5000"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-5.4999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-5"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-4.9999"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-6.9696"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
    expect (JSBD.round (JSBD.BigD ("-5.9696"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 10}).toString ()).toEqual ("0");
...
//#######################################################
{
    ...
    expect (JSBD.round (JSBD.BigD ("-54.73673"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 20}).toString ()).toEqual ("-54.74");
    expect (JSBD.round (JSBD.BigD ("-54.73673"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 20}).toString ()).toEqual ("-54.6");
    ...
    expect (JSBD.round (JSBD.BigD ("-37.21258"), {roundingMode: "floor", maximumFractionDigits: 3, roundingIncrement: 25}).toString ()).toEqual ("-37.225");
    expect (JSBD.round (JSBD.BigD ("-37.21258"), {roundingMode: "ceil", maximumFractionDigits: 2, roundingIncrement: 25}).toString ()).toEqual ("-37");
    ...
    expect (JSBD.round (JSBD.BigD ("-29.2741258"), {roundingMode: "floor", maximumFractionDigits: 5, roundingIncrement: 25}).toString ()).toEqual ("-29.27425");
    expect (JSBD.round (JSBD.BigD ("-29.2741258"), {roundingMode: "ceil", maximumFractionDigits: 4, roundingIncrement: 25}).toString ()).toEqual ("-29.2725");
    ...
    expect (JSBD.round (JSBD.BigD ("-125.273852"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 25}).toString ()).toEqual ("-125.275");
    expect (JSBD.round (JSBD.BigD ("-125.273852"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 25}).toString ()).toEqual ("-125.25");
    ...
    expect (JSBD.round (JSBD.BigD ("-1000000125.273852"), {roundingMode: "floor", maximumFractionDigits: 4, roundingIncrement: 25}).toString ()).toEqual ("-1000000125.275");
    expect (JSBD.round (JSBD.BigD ("-1000000125.273852"), {roundingMode: "ceil", maximumFractionDigits: 3, roundingIncrement: 25}).toString ()).toEqual ("-1000000125.25");
    ...
    expect (JSBD.round (JSBD.BigD ("-100000012.5"), {roundingMode: "floor", maximumFractionDigits: 0, roundingIncrement: 25}).toString ()).toEqual ("-100000025");
    expect (JSBD.round (JSBD.BigD ("-100000012.5"), {roundingMode: "ceil", maximumFractionDigits: 0, roundingIncrement: 25}).toString ()).toEqual ("-100000000");
    ...
    expect (JSBD.round (JSBD.BigD ("-100000012.5"), {roundingMode: "halfFloor", maximumFractionDigits: 0, roundingIncrement: 25}).toString ()).toEqual ("-100000025");
    expect (JSBD.round (JSBD.BigD ("-100000012.5"), {roundingMode: "halfCeil", maximumFractionDigits: 0, roundingIncrement: 25}).toString ()).toEqual ("-100000000");
